package basics
{
	...
	{
		[Embed(source="assets/basics/earth.jpg")]
		...
		override protected function onInit():void
		{
			...
			plane = new Plane(new BitmapFileMaterial("../assets/basics/earth.jpg"), earthBitmap.width, earthBitmap.height, segments, segments);
