package basics
{
	 ...
	 */
	public class ExFloatZSort extends BasicTemplate
	{
		...
		override protected function onInit():void
		{
			...
			loader = new Loader3D();
			loader.loadGeometry("../assets/dae/Total_Immersion_Anim_Object2_matrix_keys.dae", collada);
		...
		{
			renderer.useFloatZSort = !renderer.useFloatZSort;
		}
		...
		{
			title = "Away3DLite | Z-Float sorting Example | Click to toggle use of FloatZSort (" + renderer.useFloatZSort + ")";
