package lights
{
	...
	{
		[Embed(source="assets/lights/stars.jpg")]
		private var BackgroundMap:Class;

		[Embed(source="assets/lights/moon.jpg")]
		private var DiffMap2:Class;

		[Embed(source="assets/lights/MoonNormal.jpg")]
		...
		override protected function onInit():void
		{
			...
			sphere = new OBJ("../assets/lights/25_SPHERE.obj", mat, 1);
